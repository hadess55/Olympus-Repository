                            ...
                            <form id="users-userregister-form" role="form" novalidate enctype="multipart/form-data"
                                ...
                                <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-photo-holder" class=" ">
                                                    <div class="dropzone " input="#ctrl-photo" fieldname="photo"
                                                        uploadurl="{{ url('fileuploader/upload/photo') }}"
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="id_kecamatan">Id Kecamatan <span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                ...
                                <div class="card-body p-sm-1">
                                    <div class="row justify-content-center">
                                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            {{-- <img src="{{ asset('images/SIP.png') }}" alt=""
                                                class="display: inline-block; max-width: 20%;"> --}}
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('images/SIP.png') }}" class="img-fluid max-width: 10%"
                                                alt="Sample image">
