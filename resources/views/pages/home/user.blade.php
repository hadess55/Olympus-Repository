        ...
        <div class="container-fluid">
            ...
            <div class="row bg-success text-white text-center py-5">
                <div class="col-md-12">
                    <div class="card bg-white text-dark p-4">
                        ...
                        {!! $chart->container() !!}
                        <a href="{{ url('hargaprodusen-public') }}" class="btn btn-success">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <!--Kata Sambutan-->
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url('nbmpublic') }}" class="btn btn-success">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
            {{-- <div class="menu-container">
                <h2 class="text-center">Menu Aplikasi</h2>
                <div class="menu-wrapper">
                    <div class="menu-item">
                        <div class="card">
                            <img src="{{ asset('images/sayur.jpg') }}" class="card-img-top" alt="Menu 1">
                            <div class="card-body">
                                <h5 class="card-title">Data Harga Konsumen</h5>
                                <a href="hargakonsumen-public" class="btn btn-success">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                    <div class="menu-item">
                    ...
                    <div class="menu-item">
                        <div class="card">
                            <img src="{{ asset('images/sayur.jpg') }}" class="card-img-top" alt="Menu 4">
                            <div class="card-body">
                    ...
                    <div class="menu-item">
                        <div class="card">
                            <img src="{{ asset('images/sayuran.jpg') }}" class="card-img-top" alt="Menu 5">
                            <div class="card-body">
            ...
            <section class="publikasi-pangan">
                        ...
                        <div class="publikasi-card">
                            ...
                            <div class="publikasi-card-body">
                                <div class="publikasi-card-deskripsi">
                                    ...
                                    <p class="publikasi-card-text">{{ $post->kecamatan->nama }}</p>
                ...
                <div class="all-news-button">
                    <a href="{{ url('publikasi-pangan-public') }}" class="btn btn-success btn-lg" role="button">Berita
                        Terbaru</a>
                </div>
            </section>
