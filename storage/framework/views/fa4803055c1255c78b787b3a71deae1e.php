        ...
        <div class="bg-light p-3 mb-3">
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center gap-3">
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Harga Produsen</div>
                        </div>
                    </div>
                    <div class="col-auto  ">
                        <?php if($can_add){ ?>
                        <a class="btn btn-success btn-block" href="<?php print_link('hargaprodusen/add', true); ?>">
                            <i class="material-icons">add</i>
                            Tambah Harga Produsen
                        </a>
                        <?php } ?>
                    </div>
                    <div class="col-md-3  ">
                            ...
                            <div class="card mb-3 p-3 ">
                                ...
                                <div class="">
                                    <input class="form-control datepicker" value="<?php echo get_value('tanggal'); ?>" type="datetime"
                                        name="tanggal" placeholder="Select date" data-enable-time=""
                                        data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/hargaprodusen/harga_produsen_saya.blade.php ENDPATH**/ ?>