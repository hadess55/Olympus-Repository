                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-photo-holder" class=" ">
                                            <div class="dropzone " input="#ctrl-photo" fieldname="photo" uploadurl="<?php echo e(url('fileuploader/upload/photo')); ?>"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
...
<?php /**PATH C:\laragon\www\sip\resources\views/pages/account/edit.blade.php ENDPATH**/ ?>