        ...
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Edit Publikasi Pangan</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-9 comp-grid ">
                        <div class="card card-1 border rounded page-content">
                            ...
                            <form novalidate id="" role="form" enctype="multipart/form-data"
                                class="form page-form form-horizontal needs-validation" action="<?php print_link("publikasipangan/edit/$rec_id"); ?>"
                                method="post">
                                <!--[form-content-start]-->
                                <?php echo csrf_field(); ?>
                                <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-gambar-holder" class=" ">
                                                    <div class="dropzone required" input="#ctrl-gambar" fieldname="gambar"
                                                        uploadurl="<?php echo e(url('fileuploader/upload/gambar')); ?>"
                                                        ...
                                                        <input name="gambar" id="ctrl-gambar" data-field="gambar"
                                                            ...
                                                            value="<?php echo $data['gambar']; ?>" type="text" />
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/publikasipangan/edit.blade.php ENDPATH**/ ?>