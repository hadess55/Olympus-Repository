...
<?php $__env->startSection('content'); ?>
    ...
    ?>
        <div class="header-image">
            ...
            <nav>
                <a href="<?php echo e(url('/home')); ?>">BERANDA</a> > <a href="<?php echo e(url('/hargaprodusen')); ?>">HARGA PRODUSEN</a>
            </nav>
        </div>
        <div class="bg-light p-3 mb-3">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <?php if($can_add){ ?>
                        <a class="btn btn-success mb-2" href="<?php print_link('hargaprodusen/add', true); ?>">
                    ...
                    <!-- Form Search -->
                    <div class="col-md-3">
                        <form class="search d-flex" action="<?php echo e(url()->current()); ?>" method="get">
                                        ...
                                        <table id="harga-produsen" class="table">
                                            ...
                                            <tbody>
                                                <?php foreach($records as $data) { 
                                                    ...
                                                    ?>
                                                <tr>
                                                    <td><?php echo $data['kecamatan_nama']; ?></td>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            <a class="btn btn-sm btn-primary has-tooltip me-1"
                                                                href="<?php print_link("hargaprodusen/view/$rec_id"); ?>">
                                                                <i class="material-icons">visibility</i> View
                                                            </a>
                                                            <?php } ?>
                                                            <?php if($can_edit) { ?>
                                                            <a class="btn btn-sm btn-success has-tooltip me-1"
                                                                href="<?php print_link("hargaprodusen/edit/$rec_id"); ?>">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/hargaprodusen/list.blade.php ENDPATH**/ ?>