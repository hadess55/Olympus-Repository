...
<?php $__env->startSection('content'); ?>
    ...
    ?>
        <div class="header-image">
            <h1>DATA PANGAN</h1>
            <nav>
                <a href="<?php echo e(url('/home')); ?>">BERANDA</a> > <a href="<?php echo e(url('/datapangan')); ?>">DATA PANGAN</a>
            </nav>
        </div>
        <div class="bg-light mb-3">
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center gap-3">
                    ...
                    <div class="col-auto ">
                        <?php if($can_add){ ?>
                        <a class="btn btn-success btn-block" href="<?php print_link('datapangan/add', true); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-btn">
                                                    ...
                                                    <a class="btn btn-sm btn-primary has-tooltip "
                                                        href="<?php print_link("datapangan/view/$rec_id"); ?>">
                                                    ...
                                                    <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                        ...
                                                        data-display-style="modal" href="<?php print_link("datapangan/delete/$rec_id"); ?>">
                                                        <i class="material-icons">delete_sweep</i> Hapus
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-md-auto d-flex">
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records?"
                                                data-display-style="modal" data-url="<?php print_link('datapangan/delete/{sel_ids}'); ?>"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/datapangan/list.blade.php ENDPATH**/ ?>