                    ...
                    <div class="col-md-9 comp-grid ">
                        <div class="card card-1 border rounded page-content">
                            ...
                            <form id="hargakonsumen-add-form" role="form" novalidate enctype="multipart/form-data"
                                ...
                                action="<?php echo e(route('hargakonsumen.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/hargakonsumen/add.blade.php ENDPATH**/ ?>