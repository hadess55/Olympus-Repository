...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        ...
        <div class="header-image">
            <h1>NBM</h1>
            <nav>
                <a href="<?php echo e(url('/')); ?>">BERANDA</a> > <a href="<?php echo e(url('/data-pangan-public')); ?>">NBM</a>
            </nav>
        </div>
        <div class="">
                            ...
                            <div id="datapangan-list-records">
                                <div id="page-main-content" class="table-responsive">
                                    ...
                                    <table class="table table-hover table-striped table-sm text-left">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $nbm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/umum/nbmpublic.blade.php ENDPATH**/ ?>