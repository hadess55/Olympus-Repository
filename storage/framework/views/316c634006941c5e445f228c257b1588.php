...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        ...
        <div class="header-image">
            ...
            <nav>
                <a href="<?php echo e(url('/')); ?>">BERANDA</a> > <a href="<?php echo e(url('/publikasi-pangan-public')); ?>">PUBLIKASI
                    PANGAN</a>
            </nav>
        </div>
        <div class="">
                                            ...
                                            <?php $__currentLoopData = $publikasiPangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 col-lg-4 mb-4">
                                                    <div class="card shadow-sm border-0 h-100">
                                                        <img src="<?php echo e($post['gambar']); ?>" class="card-img-top"
                                                            alt="<?php echo e($post['judul']); ?>">
                                                        <div class="card-des">
                                                            <h5 class="card-title"><?php echo e($post['judul']); ?></h5>
                                                            <p class="card-text text-muted"><?php echo e($post['tahun']); ?></p>
                                                            <p class="card-text text-muted">
                                                                <?php echo e($post->kecamatan->nama ?? '-Data Kosong-'); ?>

                                                            <p>By : <?php echo e($post->author ?? '-Data Kosong-'); ?></p>
                                                            </p>
                                                            <a href="<?php echo e($post['gambar']); ?>" class="btn btn-success"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/umum/publikasipanganpublic.blade.php ENDPATH**/ ?>