        ...
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Publikasi Pangan Details</div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="page-data">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                            ...
                                            data-display-style="modal" title="Delete" href="<?php print_link("publikasipangan/delete/$rec_id?redirect=publikasipangan"); ?>">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/publikasipangan/view.blade.php ENDPATH**/ ?>