...
?>
        <div class="header-image">
            ...
            <nav>
                <a href="<?php echo e(url('/home')); ?>">BERANDA</a> > <a href="<?php echo e(url('/hargakonsumen')); ?>">HARGA KONSUMEN</a>
            </nav>
        </div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/hargakonsumen/list.blade.php ENDPATH**/ ?>