                    ...
                    <div class="col-md-9 comp-grid ">
                        <div class="card card-1 border rounded page-content">
                            ...
                            <form id="publikasipangan-add-form" role="form" novalidate enctype="multipart/form-data"
                                ...
                                action="<?php echo e(route('publikasipangan.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/publikasipangan/add.blade.php ENDPATH**/ ?>