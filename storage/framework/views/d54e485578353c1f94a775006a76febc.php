...
<?php
$pageTitle = 'Tambah Harga Produsen'; //set dynamic page title
?>
        ...
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Tambah Harga Produsen</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-9 comp-grid ">
                        <div class="card card-1 border rounded page-content">
                            <!--[form-start]-->
                            <form id="hargaprodusen-add-form" role="form" novalidate enctype="multipart/form-data"
                                class="form page-form form-horizontal needs-validation"
                                action="<?php echo e(route('hargaprodusen.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-tanggal-holder" class="input-group ">
                                                    <input id="ctrl-tanggal" data-field="tanggal"
                                                        ...
                                                        value="<?php echo get_value('tanggal', date('Y-m-d', strtotime('today'))); ?>" type="datetime" name="tanggal"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/hargaprodusen/add.blade.php ENDPATH**/ ?>