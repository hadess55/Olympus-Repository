        ...
        <div class="bg-light p-3 mb-3">
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center gap-3">
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Publikasi Pangan</div>
                        </div>
                    </div>
                    <div class="col-auto  ">
                        <?php if($can_add){ ?>
                        <a class="btn btn-success btn-block" href="<?php print_link('publikasipangan/add', true); ?>">
                            <i class="material-icons">add</i>
                            Tambah Publikasi Pangan
                        </a>
                        <?php } ?>
                    </div>
                    <div class="col-md-3  ">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="td-kecamatan_id">
                                                    <?php echo e($data->author ?? '- Data Kosong -'); ?>
                                                ...
                                                <td class="td-btn">
                                                    ...
                                                    <a class="btn btn-sm btn-primary has-tooltip "
                                                        href="<?php print_link("publikasipangan/view/$rec_id"); ?>">
                                                        <i class="material-icons">visibility</i> View
                                                    </a>
                                                    <?php } ?>
                                                    <?php if($can_edit){ ?>
                                                    <a class="btn btn-sm btn-success has-tooltip "
                                                        href="<?php print_link("publikasipangan/edit/$rec_id"); ?>">
                                                    ...
                                                    <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                        ...
                                                        data-display-style="modal" href="<?php print_link("publikasipangan/delete/$rec_id"); ?>">
                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        <div class="col-md-auto d-flex">
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records?"
                                                data-display-style="modal" data-url="<?php print_link('publikasipangan/delete/{sel_ids}'); ?>"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/publikasipangan/list.blade.php ENDPATH**/ ?>