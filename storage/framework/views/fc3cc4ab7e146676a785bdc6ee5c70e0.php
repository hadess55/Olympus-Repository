...
<?php
$pageTitle = 'Tambah Nbm'; //set dynamic page title
?>
        ...
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col  ">
                        <div class="">
                            <div class="h5 font-weight-bold text-success">Tambah Nbm</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-md-9 comp-grid ">
                        <div class="card card-1 border rounded page-content">
                            <!--[form-start]-->
                            <form id="nbm-add-form" role="form" novalidate enctype="multipart/form-data"
                                class="form page-form form-horizontal needs-validation" action="<?php echo e(route('nbm.store')); ?>"
                                method="post">
                                <?php echo csrf_field(); ?>
                                <div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sip\resources\views/pages/nbm/add.blade.php ENDPATH**/ ?>