...
class HargaProdusen extends Model 
{
     ...
     */
	protected $fillable = [
		'nama','tanggal','gkp_petani','gkg_penggilingan','beras_premium','beras_medium','jagung_pipilan_kering','cabe_besar','cabe_rawit_merah','cabe_keriting','bawang_merah','daging_ayam','daging_sapi','telur_ayam_ras','pisang','jeruk','id_kecamatan','ubi_kayu','ubi_jalar','kedelai_lokal_kering'
	];
